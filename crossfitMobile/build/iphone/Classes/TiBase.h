...
// in simulator we redefine to format for crossfitMobile Developer console
...
{\
	NSString * exceptionName = [@"org.crossfitmobile." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.crossfitmobile";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIcrossfitMobileNativeItemNone = -1, 
	UIcrossfitMobileNativeItemSpinner = -2,
	UIcrossfitMobileNativeItemProgressBar = -3,
	
	UIcrossfitMobileNativeItemSlider = -4,
	UIcrossfitMobileNativeItemSwitch = -5,
	UIcrossfitMobileNativeItemMultiButton = -6,
	UIcrossfitMobileNativeItemSegmented = -7,
	
	UIcrossfitMobileNativeItemTextView = -8,
	UIcrossfitMobileNativeItemTextField = -9,
	UIcrossfitMobileNativeItemSearchBar = -10,
	
	UIcrossfitMobileNativeItemPicker = -11,
	UIcrossfitMobileNativeItemDatePicker = -12,
	
	UIcrossfitMobileNativeItemInfoLight = -13,
	UIcrossfitMobileNativeItemInfoDark = -14,
	
	UIcrossfitMobileNativeItemDisclosure = -15,
	
	UIcrossfitMobileNativeItemContactAdd = -16
};
