...
@interface crossfitMobileObject : NSObject
@end

@interface crossfitMobileObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[crossfitMobileObject class]])
		{
			for (NSString *key in [[(crossfitMobileObject*)o modules] allKeys])
			{
